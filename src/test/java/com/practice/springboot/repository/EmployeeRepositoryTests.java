...
public class EmployeeRepositoryTests {
    ...
    public void givenEmployeeObject_whenSave_thenReturnSavedEmployee() {
       ...
       //given - precondition or setup
        // Employee Object will be created by the setup method
    ...
    public void givenEmployeeFirstAndLastNames_whenFindByJPQLIndexParams_thenReturnEmployeeObject() {
        ...
        //when - action or the behavior we are testing
        Employee employeeDB = employeeRepository.findByJPQLIndexParams(employee.getFirstName(), employee.getLastName());
